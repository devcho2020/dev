...
2. React 중앙집중식 상태관리 라이브러리 Recoil 설치: npm install recoil (yarn add recoil)
3. 외부 오픈 API 통신을 위한 라이브러리 Axios 설치: npm install axios
4. CSS 스타일링을 위한 SASS/SCSS 설치: npm install -D sass(yarn add -D sass)
...
*** 
구디사는 개발자 9Diin react 강의 참고
youtube : https://www.youtube.com/@9diin

github : https://github.com/daffy3/YT-React